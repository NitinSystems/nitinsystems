...
import { ArrowLeft, Download, CheckCircle2, ShieldCheck, Cpu } from "lucide-react";

export default function LeadQualificationProjectPage() {
  const project = PROJECTS[1]; // Smart Lead Qualification Engine
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="space-y-8 mb-12">
          <h2 className="font-serif font-bold text-2xl text-ink">
            AI Triage & Qualification Pipeline
          </h2>
        ...
        <div className="text-center bg-cobalt text-paper rounded-2xl p-8 shadow-xl space-y-4">
          <h3 className="font-serif font-bold text-2xl">
            Stop Wasting Time on Low-Fit Calls
          </h3>
          <p className="text-xs sm:text-sm text-paper/80 max-w-xl mx-auto">
            Build an automated qualification engine that protects your team's calendar while accelerating high-value opportunities.
          </p>
          <Link
            href="/audit"
